...
return [
    ...
    */
    ...
    'middleware' => [
        'web',
        'auth',
        'admin', // DISI: solo administradores pueden ver los logs (pueden contener stack traces, tokens, queries SQL, etc.)
    ...
    */
    ...
    'api_middleware' => [
        'web',
        'auth',
        'admin', // DISI: protege tambien las APIs AJAX que sirven los datos del log viewer
        AuthorizeLogViewer::class,
    ],

...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <p class="mt-1 text-xs text-gray-500">{{ __('Ej: FVB, PLBV, PONY.') }}</p>
    </div>
    ...
    <div class="md:col-span-2">
        ...
        <textarea id="description" name="description" rows="3"
                  class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $league->description ?? '') }}</textarea>

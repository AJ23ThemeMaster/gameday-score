            ...
            <div class="bg-wv-surface border border-wv-border rounded-card overflow-hidden">
                @if ($leagues->isEmpty())
                    <div class="p-10 text-center">
                        <p class="mb-4 text-wv-text-secondary">{{ __('AÃƒÂºn no hay ligas registradas.') }}</p>
                        <a href="{{ route('leagues.create') }}"
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        @if ($league->short_name)
                                            <p class="text-xs text-wv-text-secondary">{{ $league->short_name }}@if ($league->country) Ã‚Â· {{ $league->country }}@endif</p>
                                        @endif

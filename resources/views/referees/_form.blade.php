@php $person = $referee ?? null; @endphp
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <x-text-input id="certification" name="certification" type="text" maxlength="100"
                      class="block mt-1 w-full" :value="old('certification', $person->certification ?? '')"
                      placeholder="{{ __('Ej: Árbitro Principal LVBP') }}" />
